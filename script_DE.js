...
function mediamarkt(dataArr, selected_date) {
    ...
    function colors({ google_model, compare_model, plan_type, data_type, promo_type }) {
        ...
        if (promo_type == "WoW Price Change") {
            if (d == 0 && compare_model[6] > d || d < 0 && compare_model[6] > d || d > 0 && compare_model[6] > d) {
                return 'rgb(215, 230, 210)'; //green
            } else if (d < 0 && compare_model[6] < d || d > 0 && compare_model[6] == 0) {
                return 'rgb(246, 207, 203)'; //red
            } else if (d == 0 && compare_model[6] == 0) {
                return 'rgb(250, 242, 199)'; //yellow
            }
        } else {
...
function colors({ google_model, compare_model, plan_type, data_type, promo_type }) {
    ...
    if (promo_type == "WoW Price Change") {
        if (d == 0 && compare_model[6] > d) return 'rgb(246, 207, 203)'; //red
        else if (d < 0 && compare_model[6] > d) return 'rgb(215, 230, 210)'; //green
        else if (d < 0 && compare_model[6] < d) return 'rgb(246, 207, 203)'; //red
        else if (d == 0 && compare_model[6] == 0) return 'rgb(250, 242, 199)'; //yellow
    } else {
        if (compare_model[6] > d) return 'rgb(246, 207, 203)'; //red
        else if (compare_model[6] < d) return 'rgb(215, 230, 210)'; //green
